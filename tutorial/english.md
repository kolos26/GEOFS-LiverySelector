...
> [!IMPORTANT]
> You must install the latest version of the code or it won't work!
...
> [!NOTE]
> Some liveries do not have a creator listed due to being entered into the databse before the crediting feature.

> [!IMPORTANT]
> If you have enabled **potato mode**, please use the **search bar** instead to browse the liveries.

### Load External Liveries
This section allows you to upload your liveries for testing before submission, or just your ordinary virtual airline livery. You can see four different tabs in this section...
